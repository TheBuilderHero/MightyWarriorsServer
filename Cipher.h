...
class Cipher {
    private:
        ...
        string username, item2, item3, item4, item5, item6, item7, item8, item9, item10, item11; // declare the variables that are being used to store the message from the client // in some cases item2 is used.
