...
class Players : Characters { //defining the player and all their caracteristics and items
    public:
        ...
        std::string getCurrentHealthStat(std::string username); //returns the players current health from file data.
        ...
        std::string getPsychicDamageStat(std::string username, bool outputMinAndMaxString = false);
